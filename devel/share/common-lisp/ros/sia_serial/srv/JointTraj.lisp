...
(cl:defmethod cl:initialize-instance :after ((m <JointTraj-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'JointTraj-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sia_serial-srv:<JointTraj-request> is deprecated: use sia_serial-srv:JointTraj-request instead.")))

(cl:ensure-generic-function 'point-val :lambda-list '(m))
(cl:defmethod point-val ((m <JointTraj-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sia_serial-srv:point-val is deprecated.  Use sia_serial-srv:point instead.")
  (point m))
...
(cl:defmethod cl:initialize-instance :after ((m <JointTraj-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'JointTraj-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sia_serial-srv:<JointTraj-response> is deprecated: use sia_serial-srv:JointTraj-response instead.")))
